          ...
          <Reveal>
            <div className="mesh-panel edge-line rounded-md border border-white/10 p-6 shadow-glow">
              <Image
                ...
                priority
              />
              <p className="mt-8 text-sm font-semibold text-cyan">{dictionary.common.eyebrow}</p>
              <h2 className="mt-3 text-3xl font-semibold text-white">{dictionary.common.brand}</h2>
              <p className="mt-5 text-sm leading-7 text-slate-300">{about.body}</p>
            </div>
          </Reveal>
                ...
                return (
                  <Reveal key={item.title} delay={index * 0.05}>
                    <div className="h-full rounded-md border border-white/10 bg-white/[0.04] p-5">
                      <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-full bg-cyan/10 text-cyan">
