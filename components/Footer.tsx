      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
        <div>
          <div className="flex items-center gap-3">
            <Image
              ...
              width={52}
              height={52}
              className="rounded-full border border-cyan/25"
            />
            <div>
              <p className="font-semibold text-white">{dictionary.common.brand}</p>
              <p className="mt-1 text-sm text-cyan/80">{dictionary.common.eyebrow}</p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-3 text-sm">
            ...
            <a className="inline-flex items-center gap-2 text-slate-400 transition hover:text-white" href={getWhatsAppHref(locale)}>
